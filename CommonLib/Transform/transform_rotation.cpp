    ...
    for (size_t i = 0; i < nRow*nCol; i++) {
        ...
        switch (inter) {
            ...
            case INTER_LINEAR:
                ...
                break;
            case INTER_CUBIC:
                ERROR("transform_rotate", "unsupported interpolation mode");
                break;
            default:
                ERROR("transform_rotate", "unsupported interpolation mode");
        }
...
// instantiation
template
void transform_rotate<float >(const float*  const arraySrc, float*  const arrayDst,
                              size_t nRow, size_t nCol,
                              float  theta,
                              eInter inter);
template
void transform_rotate<double>(const double* const arraySrc, double* const arrayDst,
                              size_t nRow, size_t nCol,
                              double theta,
                              eInter inter);
