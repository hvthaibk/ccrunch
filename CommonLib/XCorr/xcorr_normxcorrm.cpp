                ...
                eXCorrRes shape)
{
    ...
    switch (shape) {
        ...
        case XCORR_RES_VALID:
            ...
            break;
        default:
            ERROR("normxcorrm", "unsupported xcorr mode");
    }
...
// instantiation
template
void normxcorrm<float >(float  *tplData, size_t tplNrow,
                        float  *refData, size_t refNrow,
                        float  *resData,
                        float  *mskData,
                        eXCorrRes shape);
template
void normxcorrm<double>(double *tplData, size_t tplNrow,
...
// instantiation
template
void normxcorrm<float >(float  *tplData, size_t tplNrow, size_t tplNcol,
                        float  *refData, size_t refNrow, size_t refNcol,
                        float  *resData,
                        float  *mskData,
                        eXCorrRes shape);
template
void normxcorrm<double>(double *tplData, size_t tplNrow, size_t tplNcol,
...
// instantiation
template
void normxcorrm<float >(float  *tplData, size_t tplNrow, size_t tplNcol, size_t tplNsec,
...
template
void normxcorrm<double>(double *tplData, size_t tplNrow, size_t tplNcol, size_t tplNsec,
