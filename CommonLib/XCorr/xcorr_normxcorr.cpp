               ...
               eXCorrRes shape)
{
    ...
    switch (shape) {
        ...
        case XCORR_RES_VALID:
            ...
            break;
        default:
            ERROR("normxcorr", "unsupported xcorr mode");
    }
    ...
    mskArea = xcorrNormTemplateNCC(tplDataTmp, tplSize);
    ...
    // NCC
    xcorrCombineResultNCC(resData, fftTmp1, fftTmp2, mskArea, resSize);
...
// instantiation
template
void normxcorr<float >(float  *tplData, size_t tplNrow,
                       float  *refData, size_t refNrow,
                       float  *resData,
                       eXCorrRes shape);
template
void normxcorr<double>(double *tplData, size_t tplNrow,
...
// instantiation
template
void normxcorr<float >(float  *tplData, size_t tplNrow, size_t tplNcol,
                       float  *refData, size_t refNrow, size_t refNcol,
                       float  *resData,
                       eXCorrRes shape);
template
void normxcorr<double>(double *tplData, size_t tplNrow, size_t tplNcol,
...
// instantiation
template
void normxcorr<float >(float  *tplData, size_t tplNrow, size_t tplNcol, size_t tplNsec,
                       float  *refData, size_t refNrow, size_t refNcol, size_t refNsec,
                       float  *resData,
                       eXCorrRes shape);
template
void normxcorr<double>(double *tplData, size_t tplNrow, size_t tplNcol, size_t tplNsec,
