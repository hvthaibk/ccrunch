/***********************************************************************
 *  File:       transform_expand_scaling.cu
 *
                                            ...
                                            T        factor)
{
    ...
    cuda_arrayDev_new_zero(arrayDst, nRowDst);

    cuda_array_replace<T,T>(arrayDst, nRowDst,
                            arraySrc, nRowSrc,
                                      nRowOff);
}
...
// instantiation
template
void cuda_transform_expand_scale_full<float >(const float*  const arraySrc, size_t  nRowSrc,
                                                    float*&       arrayDst, size_t& nRowDst,
                                                    float         factor);
template
void cuda_transform_expand_scale_full<double>(const double* const arraySrc, size_t  nRowSrc,
...
// instantiation
template
void cuda_transform_expand_scale_full<float >(const float*  const arraySrc, size_t  nRowSrc, size_t  nColSrc,
                                                    float*&       arrayDst, size_t& nRowDst, size_t& nColDst,
                                                    float         factor);
template
void cuda_transform_expand_scale_full<double>(const double* const arraySrc, size_t  nRowSrc, size_t  nColSrc,
...
// instantiation
template
void cuda_transform_expand_scale_full<float >(const float*  const arraySrc, size_t  nRowSrc, size_t  nColSrc, size_t  nSecSrc,
                                                    float*&       arrayDst, size_t& nRowDst, size_t& nColDst, size_t& nSecDst,
                                                    float         factor);
template
void cuda_transform_expand_scale_full<double>(const double* const arraySrc, size_t  nRowSrc, size_t  nColSrc, size_t  nSecSrc,
