 ...
 *  File:       cuNCorr.cuh
 *
 *  Purpose:    Header file for NCC computing classes
 *
 *  Author:     Thai V. Hoang
 *
...
#ifndef __GEM_CUNCORR_CUH__
#define __GEM_CUNCORR_CUH__
...
public:
     cuNCorrSingle(size_t refNrowInput,
                   size_t refNcolInput,
    ...
    void normalizeTpl(size_t mskAreaInput = 0);
...
public:
     cuNCorrDouble(size_t refNrowInput,
                   size_t refNcolInput,
                   size_t refNsecInput = 1);
    ~cuNCorrDouble();
