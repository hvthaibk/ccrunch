                    ...
                    eXCorrRes shape)
{
    ...
    switch (shape) {
        ...
        case XCORR_RES_VALID:
            ...
            break;
        default:
            ERROR("cuda_normxcorr", "unsupported xcorr mode");
    }
    ...
    mskArea = cuda_xcorrNormTemplateNCC(dev_tplDataTmp, tplSize);
...
// instantiation
template
void cuda_normxcorr<float >(float  *dev_tplData, size_t tplNrow,
                            float  *dev_refData, size_t refNrow,
                            float  *dev_resData,
                            eXCorrRes shape);
template
void cuda_normxcorr<double>(double *dev_tplData, size_t tplNrow,
...
// instantiation
template
void cuda_normxcorr<float >(float  *dev_tplData, size_t tplNrow, size_t tplNcol,
                            float  *dev_refData, size_t refNrow, size_t refNcol,
                            float  *dev_resData,
                            eXCorrRes shape);
template
void cuda_normxcorr<double>(double *dev_tplData, size_t tplNrow, size_t tplNcol,
...
// instantiation
template
void cuda_normxcorr<float >(float  *dev_tplData, size_t tplNrow, size_t tplNcol, size_t tplNsec,
                            float  *dev_refData, size_t refNrow, size_t refNcol, size_t refNsec,
                            float  *dev_resData,
                            eXCorrRes shape);
template
void cuda_normxcorr<double>(double *dev_tplData, size_t tplNrow, size_t tplNcol, size_t tplNsec,
