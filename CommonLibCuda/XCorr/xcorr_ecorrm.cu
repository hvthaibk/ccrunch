                 ...
                 eXCorrRes shape)
{
    ...
    switch (shape) {
        ...
        case XCORR_RES_VALID:
            ...
            break;
        default:
            ERROR("cuda_ecorrm", "unsupported xcorr mode");
    }
    ...
    cuda_xcorrNormTemplateECC(dev_tplDataTmp, tplSize, dev_mskData);
...
// instantiation
template
void cuda_ecorrm<float >(float  *dev_tplData, size_t tplNrow,
                         float  *dev_refData, size_t refNrow,
                         float  *dev_resData,
                         float  *dev_mskData,
                         eXCorrRes shape);
template
void cuda_ecorrm<double>(double *dev_tplData, size_t tplNrow,
...
// instantiation
template
void cuda_ecorrm<float >(float  *dev_tplData, size_t tplNrow, size_t tplNcol,
                         float  *dev_refData, size_t refNrow, size_t refNcol,
                         float  *dev_resData,
                         float  *dev_mskData,
                         eXCorrRes shape);
template
void cuda_ecorrm<double>(double *dev_tplData, size_t tplNrow, size_t tplNcol,
...
// instantiation
template
void cuda_ecorrm<float >(float  *dev_tplData, size_t tplNrow, size_t tplNcol, size_t tplNsec,
                         float  *dev_refData, size_t refNrow, size_t refNcol, size_t refNsec,
                         float  *dev_resData,
                         float  *dev_mskData,
                         eXCorrRes shape);
template
void cuda_ecorrm<double>(double *dev_tplData, size_t tplNrow, size_t tplNcol, size_t tplNsec,
